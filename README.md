...
| 2  | 1/25 | Demo: <ul><li>Github</li><li>Github Repository</li><li>Terminal</li><li>Project Brainstorm exercise</li></ul>                                                                                       | Anthony Huberman - Make it Thick: Introductory text for the exhibition "Mechanisms."     |
| 3  | 2/1  | <ul><li>Group Discussion</li><li>Workshop: [Adobe Scripting](https://www.indesignjs.de/extendscriptAPI/indesign-latest/#about.html)</li></ul>                                                       | Bruno Latour - "The Berlin Key: How to Do Words with Things.”                            |
| 4  | 2/8  | <ul><li>Group Discussion</li><li>Workshop: [DrawBot](https://www.drawbot.com/)</li><li>Group Critique</li></ul>                                                                                     | Beatriz Colomina and Mark Wigley - Are We Human?: The Invention of the Human (pp. 51-57) |
| 5  | 2/15 | <ul><li>Group Discussion</li><li>Workshop: [Chrome Extensions](https://developer.chrome.com/docs/extensions/mv3/getstarted/)</li><li>Signup for Workshop Slot</li><li>One on One meetings</li></ul> | David Reinfurt - Soft Copy (1974–1994)                                                   |
...
| 7  | 2/29 | <ul><li>Group Discussion</li><li>Workshop: [Web Scraping](https://www.crummy.com/software/BeautifulSoup/bs4/doc/)</li><li>One on One meetings</li></ul>                                             | Jorge Luis Borges - The Garden of Forking Paths                                          |
